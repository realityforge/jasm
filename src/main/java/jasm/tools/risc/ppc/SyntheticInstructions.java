...
import static jasm.tools.risc.field.Expression.Static.add;
import static jasm.tools.risc.field.Expression.Static.neg;
import static jasm.tools.risc.field.Expression.Static.sub;
import static jasm.tools.InstructionConstraint.Static.gt;
import static jasm.tools.InstructionConstraint.Static.le;
...
import static jasm.tools.risc.ppc.PPCFields.b;
import static jasm.tools.risc.ppc.PPCFields.b64;
...
import static jasm.tools.risc.ppc.PPCFields.bo_CR;
import static jasm.tools.risc.ppc.PPCFields.bo_CR_prediction;
import static jasm.tools.risc.ppc.PPCFields.bo_CTR;
import static jasm.tools.risc.ppc.PPCFields.bo_CTR_and_CR;
import static jasm.tools.risc.ppc.PPCFields.bo_CTR_prediction;
import static jasm.tools.risc.ppc.PPCFields.br_crf;
import static jasm.tools.risc.ppc.PPCFields.branch_conds;
...
import static jasm.tools.risc.ppc.PPCFields.n;
import static jasm.tools.risc.ppc.PPCFields.n64;
import static jasm.tools.risc.ppc.PPCFields.opcd;
import static jasm.tools.risc.ppc.PPCFields.put_ctr_in_name;
import static jasm.tools.risc.ppc.PPCFields.put_i_in_name;
import static jasm.tools.risc.ppc.PPCFields.put_lr_in_name;
...
import static jasm.tools.risc.ppc.PPCFields.spr_option;
import static jasm.tools.risc.ppc.PPCFields.to;
import static jasm.tools.risc.ppc.PPCFields.to_option;
...
final class SyntheticInstructions extends PPCInstructionDescriptionCreator {
    ...
    SyntheticInstructions(PPCTemplateCreator creator) {
        ...
        synthesize("subi", "addi", si(neg(value)), value);
        synthesize("subis", "addis", si(neg(value)), value);
        synthesize("subic", "addic", si(neg(value)), value);
        synthesize("subic_", "addic_", si(neg(value)), value).setExternalName("subic.");
