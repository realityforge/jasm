...
import static jasm.tools.cisc.x86.AddressingMethodCode.A;
import static jasm.tools.cisc.x86.AddressingMethodCode.C;
import static jasm.tools.cisc.x86.AddressingMethodCode.D;
import static jasm.tools.cisc.x86.AddressingMethodCode.E;
import static jasm.tools.cisc.x86.AddressingMethodCode.F;
import static jasm.tools.cisc.x86.AddressingMethodCode.G;
import static jasm.tools.cisc.x86.AddressingMethodCode.I;
...
import static jasm.tools.cisc.x86.AddressingMethodCode.Q;
...
import static jasm.tools.cisc.x86.OperandTypeCode.a;
import static jasm.tools.cisc.x86.OperandTypeCode.b;
import static jasm.tools.cisc.x86.OperandTypeCode.d;
import static jasm.tools.cisc.x86.OperandTypeCode.d_q;
import static jasm.tools.cisc.x86.OperandTypeCode.dq;
import static jasm.tools.cisc.x86.OperandTypeCode.p;
import static jasm.tools.cisc.x86.OperandTypeCode.pd;
import static jasm.tools.cisc.x86.OperandTypeCode.ps;
import static jasm.tools.cisc.x86.OperandTypeCode.q;
import static jasm.tools.cisc.x86.OperandTypeCode.s;
import static jasm.tools.cisc.x86.OperandTypeCode.sd;
import static jasm.tools.cisc.x86.OperandTypeCode.ss;
import static jasm.tools.cisc.x86.OperandTypeCode.v;
import static jasm.tools.cisc.x86.OperandTypeCode.w;
import static jasm.tools.cisc.x86.OperandTypeCode.z;
