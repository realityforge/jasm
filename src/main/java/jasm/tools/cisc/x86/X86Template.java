...
public abstract class X86Template extends Template implements X86InstructionDescriptionVisitor {
    ...
    public final X86TemplateContext.ModCase modCase() {
    ...
    public final X86TemplateContext.RMCase rmCase() {
    ...
    public final X86TemplateContext.SibBaseCase sibBaseCase() {
    ...
    public final void visitAddressingMethodCode(AddressingMethodCode addressingMethodCode, X86Operand.Designation designation) throws TemplateNotNeededException {
    ...
    public final void visitGeneralRegister(GeneralRegister generalRegister, X86Operand.Designation designation, ImplicitOperand.ExternalPresence externalPresence) {
        addImplicitOperand(new X86ImplicitOperand(designation, externalPresence, generalRegister));
    }

    public final void visitSegmentRegister(SegmentRegister segmentRegister, X86Operand.Designation designation) {
    ...
    public final void visitFloatingPointOperandCode(FloatingPointOperandCode floatingPointOperandCode, X86Operand.Designation designation,
    ...
    public final void visitFPStackRegister(FPStackRegister fpStackRegister, X86Operand.Designation designation) {
    ...
    public final void visitInteger(Integer integer, X86Operand.Designation designation) {
