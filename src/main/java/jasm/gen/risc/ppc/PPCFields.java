...
import jasm.gen.risc.field.AlignedImmediateOperandField;
...
final class PPCFields {
    ...
    public static final SymbolicOperandField<CRF> bfa = SymbolicOperandField.createAscending(CRF.SYMBOLS, 11, 13);
    public static final SymbolicOperandField<CRF> br_crf = SymbolicOperandField.createAscending(CRF.SYMBOLS, 11, 13).setVariableName("crf");

    public static final ImmediateOperandField spr = ImmediateOperandField.createAscending(16, 20, 11, 15);

    public static final SymbolicOperandField<FPR> frt = SymbolicOperandField.createAscending(FPR.SYMBOLS, 6, 10);
    public static final SymbolicOperandField<FPR> frs = SymbolicOperandField.createAscending(FPR.SYMBOLS, 6, 10);
    public static final SymbolicOperandField<FPR> fra = SymbolicOperandField.createAscending(FPR.SYMBOLS, 11, 15);
    public static final SymbolicOperandField<FPR> frb = SymbolicOperandField.createAscending(FPR.SYMBOLS, 16, 20);
    public static final SymbolicOperandField<FPR> frc = SymbolicOperandField.createAscending(FPR.SYMBOLS, 21, 25);

    public static final SymbolicOperandField<BOOperand> bo = SymbolicOperandField.createAscending(BOOperand.SYMBOLS, 6, 10);
    ...
    public static final InputOperandField value = InputOperandField.create(si);
    ...
    static {
      NamedField.initStaticFieldNames(PPCFields.class);
    }
}
